...
<head>
    ...
    <title>Dealord: Seller Portal | E-commerce Order details</title>
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item active" href="ecommerce_order_details.html">Order details</a>
                                </li>
                                <li>
                        ...
                        <div class="ibox">
                            <div class="ibox-body">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-8 h3 font-strong text-pink mb-0">$1201.71</div>
                                </div>
                                <div class="row align-items-center mb-3">
